...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        Accuracy_list.append(acc.tolist())
        meanIOU_list.append(iu.mean().item())
        # write into txt
        print(Accuracy_list)
    ...
    plt.subplot(3, 1, 3)
    plt.plot(x2, y3, '.-')
    plt.xlabel('Test meanIOU vs. epoches')
    plt.ylabel('Test meanIOU')
    plt.show()
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="/fcn", help="VOCdevkit root")
